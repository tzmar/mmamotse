  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300 ease-out pb-20">
      <header className="space-y-1 sm:space-y-2">
        <h1 className="text-3xl sm:text-5xl font-black tracking-tight">Configuration</h1>
        <p className="opacity-50 font-bold uppercase tracking-widest text-xs sm:text-sm">Personalize Your Finance Engine</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="md:col-span-2">
          <GlassCard>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-black uppercase tracking-wider opacity-70">Appearance</h2>
            </div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <p className="text-xs sm:text-sm opacity-60 flex-1">Choose how PulaPocket looks. 'System' will match your device's current theme.</p>
              <ThemeSwitcher />
            </div>
          </GlassCard>
        </div>
        ...
        <GlassCard>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-black uppercase tracking-wider opacity-70">Money In Categories</h2>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {settings.inCategories.map(cat => (
                <div key={cat} className="glass px-4 py-2 rounded-full flex items-center gap-2 group transition-all">
                  <span className="text-xs sm:text-sm font-bold">{cat}</span>
        ...
        <GlassCard>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-black uppercase tracking-wider opacity-70">Money Out Categories</h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex-1 min-w-0">
        ...
        <div className="md:col-span-2">
          <GlassCard>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-black uppercase tracking-wider opacity-70">Safety Limits (Monthly)</h2>
            </div>
            <p className="text-xs sm:text-sm opacity-40 mb-8 italic">Set a maximum monthly spend for your outflow categories. The system will warn you if exceeded.</p>
